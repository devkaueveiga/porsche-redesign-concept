...
export function CTA() {
  return (
    <section id="contact" className="py-24 md:py-32 px-6 md:px-12 bg-black text-white relative">
      ...
      >
        <h2 className="text-4xl md:text-6xl mb-6 font-bold tracking-wide uppercase">Experiência de Excelência</h2>
        <p className="text-gray-300 text-lg md:text-xl mb-12 max-w-2xl mx-auto font-light leading-relaxed">
          Agende um test drive ou visite nosso Porsche Center para descobrir o que torna o GT3 RS verdadeiramente excepcional.
        </p>
        ...
        <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-12">
          {[
            { value: "518 lb-ft", label: "TORQUE MÁX" },
            { value: "9.000 RPM", label: "REDLINE" },
            { value: "409 lb", label: "DOWNFORCE" }
          ].map((stat, i) => (
            <motion.div 
              key={i}
