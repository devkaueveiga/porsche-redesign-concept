    ...
    <section id="design" className="py-24 md:py-32 px-6 md:px-12 bg-zinc-950 text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-0">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <h2 className="text-4xl md:text-6xl mb-6 font-bold tracking-wide uppercase">{t.design.title}</h2>
            ...
            <div className="space-y-8">
              {[
                { num: "01", title: t.design.carbonBody, desc: t.design.carbonBodyDesc },
                { num: "02", title: t.design.rearWing, desc: t.design.rearWingDesc },
                { num: "03", title: t.design.raceChassis, desc: t.design.raceChassisDesc }
              ].map((item, i) => (
                <motion.div 
                  key={i}
                  whileHover={{ x: 10 }}
          ...
          >
            ...
            <img
              src="/images/design/aerodynamics.jpg"
              alt="Porsche 911 GT3 RS aerodinâmica"
