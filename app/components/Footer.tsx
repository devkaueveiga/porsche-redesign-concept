      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-16 mb-16">
          ...
          >
            ...
            <ul className="space-y-4 text-gray-500 text-sm font-light">
              {[t.footer.findDealer, t.footer.scheduleService, t.footer.porscheExclusive, t.footer.motorsport].map(link => (
                <li key={link}>
                  <a href="#" className="hover:text-porscheRed transition-colors duration-300 flex items-center gap-2 group">
                    <span className="w-0 h-[1px] bg-porscheRed transition-all duration-300 group-hover:w-4" />
                    {link}
        ...
        >
          ...
          <div className="flex gap-8">
            <a href="#" className="hover:text-porscheRed transition-colors tracking-wide uppercase">{t.footer.legal}</a>
            <a href="#" className="hover:text-porscheRed transition-colors tracking-wide uppercase">{t.footer.privacy}</a>
            <a href="#" className="hover:text-porscheRed transition-colors tracking-wide uppercase">{t.footer.cookies}</a>
          </div>
        </motion.div>
      </div>
    </footer>
