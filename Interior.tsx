        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <img
              ...
              alt="Porsche 911 Interior e painel de instrumentos"
          ...
          >
            <h2 className="text-4xl md:text-6xl mb-6 font-bold tracking-wide uppercase">Cockpit Focado no Piloto</h2>
            <p className="text-gray-300 mb-10 text-lg leading-relaxed font-light">
              Cada controle, cada superfície desenvolvida ao redor de quem dirige. A ergonomia inspirada nas corridas encontra o acabamento premium para a máxima experiência de pilotagem.
            </p>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {[
                { title: "Volante Esportivo RS", desc: "Forrado em Race-Tex com marcação central ajustável." },
                { title: "Sport Chrono", desc: "Cronômetro analógico e digital projetado para tracking de voltas." },
                { title: "Pacote de Carbono", desc: "Acabamento ultraleve do painel e console." },
                { title: "Bancos Concha", desc: "Suporte lateral perfeito em fibra de vidro reforçada (CFRP)." }
              ].map((card, idx) => (
                <motion.div 
                  key={idx}
